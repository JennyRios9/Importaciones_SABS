...
namespace Importaciones_SABS.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Cedula,Telefono,Correo,Estado,rol_id")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Cedula,Telefono,Correo,Estado,rol_id")] Usuarios usuarios)
        {
            if (id != usuarios.Id)
            {
                return NotFound();
